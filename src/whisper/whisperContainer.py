...
class WhisperContainer(AbstractWhisperContainer):
    ...
    def ensure_downloaded(self):
        ...
        try:
            ...
            if self.model_name in whisper._MODELS:
                ...
                # If the model is not in the official list, see if it needs to be downloaded or converted
                self._get_model_path(model_config, root_dir)
            return True
    ...
    def _get_model_path(self, model_config: ModelConfig, root_dir: str = None):
        ...
        if model_type in ["huggingface", "hf", "transformers"]:
